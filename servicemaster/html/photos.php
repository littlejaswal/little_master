       ...
       <div id="ourservicesmiddle21">
        <div id="restorationpanel21">
         <div id="restorationtext21">
          <div id="breadcrumb"><a href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Photo Galleries</div>
	<p>Please select a gallery to view its images</p>
	<?php if(count($galleries)): $sr=1;?>
		<?php foreach ($galleries as $k=>$v):?>
			<?php $caption=$v->description;?>
			<?php $image=$v->image;?>
			<?php $gid=$v->id;?>
