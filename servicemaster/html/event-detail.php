...
?>
 <div id="leftpanel21">
	...
	<div id="breadcrumb"><a href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;<a href="<?php echo make_url('events')?>">Events</a>&nbsp;&raquo;&nbsp;Event Detail </div>
	<?php
		include(DIR_FS_SITE.'template/events-complete.php');
	?>
            </div>	
            </div>
            </div>
