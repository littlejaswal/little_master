...
?>
    ...
    <div id="ourservicepanel21">
      <div id="ourservicetop21">
        <div id="ourservicestext21">Testimonials</div>
      </div>
       <div id="ourservicesmiddle21">
        <div id="restorationpanel21">
         <div id="restorationtext21">

<div id="breadcrumb"><a href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Testimonials</div>
<?php if($list->TotalPages>1):?>
	<div class="paging"><?php echo PageControl_front($list->PageNo, $list->TotalPages, $list->TotalRecords, 'testimonials', '', 2, '', '', 'Testimonials');?></div>
<?php endif;?>

<?php if($list->GetNumRows()):?>
	<?php while($v=$list->GetObjectFromRecord()) { ?>
				<?php include(DIR_FS_SITE.'template/testimonial.php');?>		
	<?php }	?>
<?php endif;?>

<?php if($list->TotalPages>1 && $list->TotalRecords > 4):?>
<div class="paging"><?php echo PageControl_front($list->PageNo, $list->TotalPages, $list->TotalRecords, 'testimonials', '', 2, '', '', 'Testimonials');?></div>
<?php endif;?>
