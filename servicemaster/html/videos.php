...
<div id="leftpanel21">
    <div id="ourservicepanel21">
      <div id="ourservicetop21">
        <div id="ourservicestext21">Videos</div>
      </div>
       <div id="ourservicesmiddle21">
        <div id="restorationpanel21">
         <div id="restorationtext21">
	<div id="breadcrumb">
	<a href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Videos
	</div>
	<br/>
	<?php if($query->TotalPages>1):?>
		<div id="breadcrumb"><?php echo PageControl_front($query->PageNo, $query->TotalPages, $query->TotalRecords, 'videos', '', 2, '', '', 'videos');?></div>
	<?php endif;?>
	
	<?php if(count($list)):?>
		<?php foreach ($list as $key=>$value):?>
			<?php include(DIR_FS_SITE.'template/video-player.php');?>
		<?php endforeach;?>
	<?php endif;?>
	</div>
