...
?>
	...
	<div id="breadcrumb"><a href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Blog</div>
	<?php if($blog->TotalPages>1):?>
		<div class="paging"><?php echo PageControl_front($blog->PageNo, $blog->TotalPages, $blog->TotalRecords, 'blog', '', 2, '', '', 'Posts');?></div>
	<?php endif;?>
	<?php while ($object=$blog->GetObjectFromRecord())
		{
				include(DIR_FS_SITE.'template/blog-post.php');
		}
	?>
	<?php if($blog->TotalPages>1 && $blog->TotalRecords>3):?>
		<div class="paging"><?php echo PageControl_front($blog->PageNo, $blog->TotalPages, $blog->TotalRecords, 'blog', '', 2, '', '', 'Posts');?></div>
	<?php endif;?>
</div>
</div>
