...
?>
    ...
    <div id="ourservicepanel21">
      <div id="ourservicetop21">
        <div id="ourservicestext21">FAQ</div>
      </div>
       <div id="ourservicesmiddle21">
        <div id="restorationpanel21">
         <div id="restorationtext21">
<div id="breadcrumb"><a href="<?php echo make_url('home');?>">Home</a>&nbsp;&raquo;&nbsp;Faq</div>
<?php
if($faqquery->GetNumRows()):
	while($object=$faqquery->GetObjectFromRecord()):
		echo '<div class="question">'.$object->question.'</div>';
		echo '<div class="answer">'.html_entity_decode($object->answer).'</div>';
	endwhile;
else:
	echo 'Sorry, No Frequently Asked Question Found.';
endif;
?>
</div>
</div>
