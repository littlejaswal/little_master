...
font-weight:bold;
	...
	<div align="left" style="padding-left:10px;">
		<?php if($codd->payment_status==1):?>
			<a href="<?=make_admin_url('custom_payment','list','list')?>">Complete Custom order listing</a><br/><br/>
		<?php else:?>
			<a href="<?=make_admin_url('custom_order','list','list')?>">Custom order listing</a><br/><br/>	
		<?php endif;?>	

		<table width="600" border="0" align="left" cellpadding="0" cellspacing="0" class="main">
					...
					<?$total=0;while($ordert=$ordertt->GetObjectFromRecord()):?>
						...
						<?endwhile;?>
							<table width="100%" border="0" cellspacing="1" cellpadding="0">
								...
								<tr>
									<td class="calc_cell" valign="top" width="50%">Note</td>
									<td class="calc_cell" valign="top"><?=$codd->note?></td>
								</tr>
							</table>
				  </td>
		  </tr>
						...
						<td align="left">
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0">
								...
								<tr>
									...
									<td class="rtcell" valign="top"><input type="hidden" name="orderid" value="<?=$codd->id?>"><input type="submit" name="submit" value="Pay Now" class="frmButton"></td>
								</tr>
							</table>
						</td>
					</tr>
