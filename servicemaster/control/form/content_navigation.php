...
switch ($section):
	case 'list':
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;">
			...
			<tr>
				<td colspan="5">
				<?php echo PageControl($QueryObj->PageNo, $QueryObj->TotalPages, $QueryObj->TotalRecords, DIR_WS_SITE_CONTROL.'control.php', 'Page=content_navigation', 2);?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center">
				<?=make_admin_link(make_admin_url('content_navigation', 'update', 'update', 'id='.$news->id), get_control_icon('edit'));?></td>
				<td align="center"><?=make_admin_link(make_admin_url('content_navigation', 'delete', 'list', 'id='.$news->id), get_control_icon('cancel'));?>
				</td>
			</tr>
			</tbody>
			<?endwhile;?>
		...
		<br/>
		<br/>
		<form id="method" action="<?=make_admin_url('content_navigation', 'insert', 'list')?>" method="post" name="payment-method">
			<table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;">
				<!--<tr>
					<td colspan="3" ><?=make_admin_link(make_admin_url('content_navigation', 'list', 'list'), 'Back to navigation listing')?></td>
				</tr>-->
				<tr>
					<td align="left" colspan="3" class="table_head">New navigation Item</td>
				</tr>
				<tr>
	...
	case 'update':
		#html code here.
		?>
			<form id="method" action="<?=make_admin_url('content_navigation', 'update', 'list')?>" method="post" name="payment-method">
			<table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;">
				<tr>
					<td colspan="3" ><?=make_admin_link(make_admin_url('content_navigation', 'list', 'list'), 'Back to navigation listing')?></td>
				</tr>
