...
//echo DIR_FS_SITE_TEMPLATE_INC; die;
?>
...
?>
    ...
    <div id="homeSlider">
    <h1>Need A Hard Working Realtor?</h1>
    <div class="homeSlider">    	
        <img src="<?php echo DIR_WS_SITE_GRAPHIC?>home.jpg" alt="Buy With Confidence" />       
    </div>
    </div>
	
	<div id="content" style="padding-top: 50px;">
    	<h1 class="welcome">Welcome</h1>
    	<img class="cynthiaGomez" src="<?php echo DIR_WS_SITE_GRAPHIC?>cynthiaGomez.png" alt="Cynthia Gomez"  />
			<!--  content -->
